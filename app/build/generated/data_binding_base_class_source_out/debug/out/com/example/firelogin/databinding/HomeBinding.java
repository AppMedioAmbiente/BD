...
public final class HomeBinding implements ViewBinding {
  ...
  private HomeBinding(@NonNull DrawerLayout rootView, @NonNull AppBarHomeBinding appBarHome,
  ...
  public static HomeBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new HomeBinding((DrawerLayout) rootView, binding_appBarHome, drawerLayout, navView);
    }
