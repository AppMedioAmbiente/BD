...
public final class SettingsInterfaceBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public static SettingsInterfaceBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static SettingsInterfaceBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.settings_interface, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static SettingsInterfaceBinding bind(@NonNull View rootView) {
