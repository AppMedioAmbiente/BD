...
public final class FragmentGroupsBinding implements ViewBinding {
  ...
  private FragmentGroupsBinding(@NonNull FrameLayout rootView, @NonNull TextView textGroups) {
  ...
  public static FragmentGroupsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentGroupsBinding((FrameLayout) rootView, textGroups);
    }
